...
class GenericContext(BaseContext, t.Generic[C]):
    ...
    def load(self, update_schemas: bool = True) -> GenericContext[C]:
        ...
        for loader in self._loaders:
            with sys_path(loader.context_path):
                projects.append(loader.load())
        ...
        project_types = {loader.config.loader.__name__.lower() for loader in self._loaders}
    ...
    def _load_materializations_and_signals(self) -> None:
        if not self._loaded:
            for loader in self._loaders:
                with sys_path(loader.context_path):
                    loader._load_materializations(self)
